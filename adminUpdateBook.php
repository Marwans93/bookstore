    ...
    <div id="templatemo_content">
		...
		<a style="background:none" href="adminEditBook.php"> Back </a>
				...
				<form>
					...
					<tr>
						<td><center><a href="adminUpdateBook1.php?user_id=<?php print ($row['isbn']);?>"><?php echo $row['isbn'];?></a></td>
						
						<td> <?php echo $row['title'];?> </td>
						<td> <?php echo $row['author'];?> </td>
						<td> <?php echo $row['price'];?> </td>
						
						<td><center><a href="adminUpdateBook1.php?user_id=<?php print ($row['isbn']);?>"><b>Edit</b></a></td>
					</tr>
					<?php  // looping close
					}?>
