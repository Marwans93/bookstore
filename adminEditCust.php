...
$data = mysql_query("Select * from register ") or die("Database Error");
?>
...
<div id="templatemo_container">
    ...
    <div id="templatemo_content">
		...
		<h1> <font color="white"> Customer's </font> </h1>
		<a style="background:none" href="adminIndex.php"> Back </a>
				...
				<form>
					...
					<tr>
							<td><center><b>Customer's Username</b></td> <td><center><b>Option</b></td> 
					</tr>
					...
					<tr>
						<td><center><a href="adminEditCust1.php?user_id=<?php print ($row['username']);?>"><?php echo $row['username'];?></a></td>
						
						<td><center><a href="adminEditCust1.php?user_id=<?php print ($row['username']);?>"><b>Edit</b></a></td>
					</tr>
					<?php  // looping close
					}?>
